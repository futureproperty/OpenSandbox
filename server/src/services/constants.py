...
class SandboxErrorCodes:
    ...
    # Port-forward error codes
    PORT_FORWARD_NOT_SUPPORTED = "PORT_FORWARD::NOT_SUPPORTED"
    PORT_FORWARD_PORT_CONFLICT = "PORT_FORWARD::PORT_CONFLICT"
    PORT_FORWARD_NOT_FOUND = "PORT_FORWARD::NOT_FOUND"
    PORT_FORWARD_SANDBOX_NOT_FOUND = "PORT_FORWARD::SANDBOX_NOT_FOUND"
    PORT_FORWARD_K8S_ERROR = "PORT_FORWARD::K8S_ERROR"
    PORT_FORWARD_INVALID_PORT = "PORT_FORWARD::INVALID_PORT"
